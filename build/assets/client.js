...
$(document).on('submit', '.js-newuser-form', function (event) {
    ...
    if (email == "") {
        ...
        $.ajax({
                type: 'POST',
                url: 'https://book-search-fullstack-capstone.herokuapp.com/users/create',
                dataType: 'json',
...
$(document).on('click', '.login', function (event) {
    ...
    if ((!email) || (email.length < 1) || (email.indexOf(' ') > 0)) {
        ...
        $.ajax({
                type: "POST",
                url: "https://book-search-fullstack-capstone.herokuapp.com/users/signin",
                dataType: 'json',
...
$(document).on('click', '.searchbtn', function (event) {
    ...
    if ((!searchString) || (searchString.length < 1)) {
        ...
        $.ajax({
                type: "GET",
                url: 'https://book-search-fullstack-capstone.herokuapp.com/book-search-title/' + searchString,
                dataType: 'json',
            })
...
$(document).on('click', '.continuebtn', function (event) {
    ...
    $.ajax({
            ...
            dataType: 'json',
            contentType: 'application/json',
            url: 'https://book-search-fullstack-capstone.herokuapp.com/get-book-db/' + username,
        })
        .done(function (result) {
            console.log(result);
            buildList(result);
...
$(document).on('submit', '.savebtn', function (event) {
    ...
    $.ajax({
            ...
            dataType: 'json',
            contentType: 'application/json',
            url: 'https://book-search-fullstack-capstone.herokuapp.com/retrieve-sList/',
        })
        .done(function (result) {
            buildList(result);
        })
...
$(document).on('click', '.reviewbtn', function (event) {
    ...
    $.ajax({
            method: "PUT",
            url: "https://book-search-fullstack-capstone.herokuapp.com/update-review/" + updatedReviewId,
            dataType: 'json',
            contentType: 'application/json',
...
$(document).on('click', ".deletebtn", function (event) {
    ...
    if (confirm('Are you sure you want to delete this book and review?') == true) {
        ...
        $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json',
                url: "https://book-search-fullstack-capstone.herokuapp.com/book/" + idValue,
            })
            .done(function (result) {
                console.log(result);
                let username = $('.js-query-username').val();
...
//        dataType: 'json',
//        contentType: 'application/json',
//        url: 'https://book-search-fullstack-capstone.herokuapp.com/book/:id' + idValue,
//    })
//        .done(function (result) {
...
//            dataType: 'json',
//            contentType: 'application/json',
//            url: 'https://book-search-fullstack-capstone.herokuapp.com/delete-empty-books/'
//        })
//            .done(function (result) {
//            console.log(result);
//            $('#' + nameValue).remove();
...
$(document).on('click', '.addbtn', function (event) {
    ...
    $.ajax({
            ...
            url: 'https://book-search-fullstack-capstone.herokuapp.com/add-book-db/',
        })
        .done(function (result) {
            console.log(result);
...
//        $.ajax({
//                type: 'POST',
//                url: 'https://book-search-fullstack-capstone.herokuapp.com/ingredients/create',
//                dataType: 'json',
...
//        $.ajax({
//                type: "GET",
//                url: 'https://book-search-fullstack-capstone.herokuapp.com/search-recipes/' + searchString,
//                dataType: 'json',
//            })
//            .done(function (dataOutput) {
//                console.log(dataOutput);
...
//            dataType: 'json',
//            contentType: 'application/json',
//            url: 'https://book-search-fullstack-capstone.herokuapp.com/delete/' + idValue,
//        })
//        .done(function (result) {
//            displayError("Deleted");
//            //if the last quantity of an ingredient is deleted delete the parent ingredient too
...
//                    dataType: 'json',
//                    contentType: 'application/json',
//                    url: 'https://book-search-fullstack-capstone.herokuapp.com/delete-empty-ingredients/'
//                })
//                .done(function (result) {
//                    console.log(result);
//                    $('#' + nameValue).remove();
...
//            url: 'https://book-search-fullstack-capstone.herokuapp.com/add-recipe-db/',
//        })
//        .done(function (result) {
//            console.log(result);
//            displayError("Added to list");
